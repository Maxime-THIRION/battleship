    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP and event.button == 1:
                ...
                x ='Victoire'
                if x =='Victoire' or finpartie(grille_pla, bateaux_ia)=='Défaite':
                    #running = False
                ...
                if event.key == pygame.K_h and pouvoir == 'triplette maudite' and pouvoir_actif == True:
                    orientation_pouvoir = 'Horizontal'
                if event.key == pygame.K_RETURN and fin_partie == 1:
        ...
        police_fin = pygame.font.Font(None, 70)
        ...
        if fin_partie==0:
            ...
            info_texte = "Pour relancer une partie : Enter"  
            texte_info = police.render(info_texte, True, (255, 165, 0))
            fenetre.blit(texte_info, (250, 300)) 

            info_texte2 = "Pour quitter : Echap "  
            texte_info2 = police.render(info_texte2, True, (255, 165, 0))
            fenetre.blit(texte_info2, (250, 330)) 
